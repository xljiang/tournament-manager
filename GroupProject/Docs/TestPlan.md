...
| I2          | Verify Manager can manage matches  | JUnit test | can (1) add match, return Match (2) end a match |Able to add a ready match,end a match based on the match status,STATUS_READY.STATUS_FINISHED |Pass |V | separate tests are excecuted for add,end match|

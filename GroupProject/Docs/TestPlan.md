...
| I3.3        | Verify Manager can manage tournaments (3) issue refund | manual tests | give correct amount of money back to a not completed but already terminated tournament, also refund to this tournament players | Same amount of money per player before tournament as after it is ended early | As expected | pass | KK |
